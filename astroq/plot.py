...
# Add missing function that was being called but not defined
def get_requests_frame(semester_planner, filter_condition=None):
    """
    Generate HTML table of requests frame with optional filtering.
    
    Args:
        semester_planner: SemesterPlanner object
        filter_condition: Optional string filter condition (e.g., "program_code=='U268'")
        
    Returns:
        str: HTML string of the filtered dataframe
    """
    df = semester_planner.requests_frame.copy()
